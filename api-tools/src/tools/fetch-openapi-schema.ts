...
export const fetchOpenApiSchemaTool = {
    name: 'fetch_openapi_schema',
    description: `Fetches and parses an OpenAPI schema from a URL.
  ...
  ## Example usage:
  - Public Schema: fetch_openapi_schema({schemaUrl: "https://petstore.swagger.io/v2/swagger.json"})
